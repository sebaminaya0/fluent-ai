...
class TestLazyModelLoaderMocking(unittest.TestCase):
    ...
    def test_progress_callback_called(self, mock_pipeline):
        ...
        self.progress_callback.assert_any_call("Loading translator es -> en...", 0.0)
        self.progress_callback.assert_any_call("Loaded translator es -> en", 100.0)
    ...
    def test_load_all_for_languages(self, mock_pipeline):
        ...
        expected_results = {"es->en": True, "en->es": True}
