...
def test_database_functionality():
    ...
    db_logger.log_audio_playback(
        ...
        latency_ms=45.8,
        language="en",
        metadata={"sample_rate": 44100, "audio_samples": 132300, "chunk_size": 1024},
    )
    ...
    if translation_summary:
        ...
        print(
            f"   Languages: {translation_summary['input_language']} → {translation_summary['output_language']}"
        )
...
if __name__ == "__main__":
    ...
    print(
        "   - Query logs: SELECT * FROM translation_logs ORDER BY timestamp DESC LIMIT 10;"
    )
    print(
        "   - Query translations: SELECT * FROM translations ORDER BY timestamp DESC LIMIT 5;"
    )
